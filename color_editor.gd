...
func _on_lineedit_r_text_changed(new_text):
...
func _on_lineedit_g_text_changed(new_text):
...
func _on_lineedit_b_text_changed(new_text):
...
func _on_lineedit_a_text_changed(new_text):
